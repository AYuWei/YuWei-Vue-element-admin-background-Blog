  ...
  <div class="login-container">
    ...
    >
      ...
      <div class="captchaContainer">
        ...
        <div class="captchaImg" v-html="svg" @click="getCaptchaAsync"></div>
      </div>
      <el-checkbox v-model="loginForm.checked" class="checkbox"
        >7 天内免密登录</el-checkbox
      >
      <el-button
        :loading="loading"
        type="primary"
