<template>
  <div class="app-container">
    ...
    <!-- 序号 -->
     ...
     <!-- 评论文章 -->
     <el-table-column prop="date" label="评论文章" align="center">
...
<script>
import { getAllComments , delOneComment } from "@/api/comments.js"
...
export default {
  ...
  methods: {
    // 获取数据列表
    getAllCommentsList() {
      getAllComments(this.page, this.limit).then(res => {
